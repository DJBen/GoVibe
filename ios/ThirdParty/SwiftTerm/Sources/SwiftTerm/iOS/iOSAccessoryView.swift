...
public class TerminalAccessory: UIInputView, UIInputViewAudioFeedback {
    ...
    public init (frame: CGRect, inputViewStyle: UIInputView.Style, container: TerminalView)
    {
        ...
        // UIInputView's .keyboard style background is unreliable on rotation;
        // set it explicitly so it persists through orientation changes.
    ...
    public override func traitCollectionDidChange(_ previousTraitCollection: UITraitCollection?) {
        ...
        // Only rebuild when the visual style changes (dark/light mode), not on rotation.
        // Rotation triggers traitCollectionDidChange too, but bounds.didSet already
        // handles the width-change rebuild; a second setupUI() call here would race
        // with UIKit's keyboard animation and corrupt the background.
